...
class QualityService:
    ...
    def create_quality_alert(self, name: str, product_id: int, team_id: int | None = None, priority: str = "0") -> dict[str, Any]:
    ...
    def update_quality_alert(self, alert_id: int, data: dict[str, Any]) -> dict[str, Any]:
