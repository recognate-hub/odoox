...
class DiscussService:
    ...
    def post_message(self, res_model: str, res_id: int, body: str, message_type: str = "comment") -> dict[str, Any]:
        msg_id = self.odoo.post_message(res_model, res_id, body, message_type)
        return {"status": "success", "message_id": msg_id}

    def create_channel(self, name: str, channel_type: str = "channel") -> dict[str, Any]:
