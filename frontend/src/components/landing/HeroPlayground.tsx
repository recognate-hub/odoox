...
export default function HeroPlayground() {
  ...
  const copySnippet = () => {
    navigator.clipboard.writeText(`pip install odoox-mcp && odoox connect --url https://your-odoo-instance.com`);
    setCopied(true);
    setTimeout(() => setCopied(false), 2000);
  };

  return (
    <div id="playground" className="w-full max-w-7xl mx-auto px-4 sm:px-6 pt-32 pb-20 relative">
      {/* Background Glow Orbs */}
      <div className="absolute top-1/3 left-1/2 -translate-x-1/2 w-[900px] h-[500px] bg-gradient-to-tr from-lime-500/10 via-emerald-500/10 to-teal-500/5 blur-[140px] rounded-full pointer-events-none" />
      <div className="absolute top-10 right-10 w-96 h-96 bg-lime-500/5 blur-[100px] rounded-full pointer-events-none" />
      ...
      <div className="text-center max-w-4xl mx-auto mb-16 relative z-10">
        <motion.div
          ...
          className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-lime-500/20 bg-lime-500/10 text-lime-400 text-xs font-semibold tracking-wider uppercase mb-6 shadow-[0_0_15px_rgba(163,230,53,0.15)]"
        >
          <Sparkles className="w-3.5 h-3.5" />
          Native Model Context Protocol (MCP) for Odoo ERP
        </motion.div>
        ...
        >
          <div className="w-full sm:w-auto flex items-center justify-between gap-4 px-5 py-3 rounded-full bg-zinc-900/90 border border-white/10 text-zinc-300 font-mono text-xs sm:text-sm shadow-inner">
          ...
          <a
            href="#playground"
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-6 py-3 rounded-full font-semibold text-sm text-black bg-gradient-to-r from-lime-400 to-emerald-400 hover:opacity-95 transition-transform active:scale-95 shadow-[0_0_25px_rgba(163,230,53,0.3)]"
          >
            Try Live Interactive Playground <ArrowRight className="w-4 h-4" />
          </a>
        </motion.div>
      </div>
      ...
      <motion.div
        ...
        className="relative z-10 rounded-3xl border border-white/10 bg-gradient-to-b from-zinc-900/90 via-zinc-950/95 to-black p-4 sm:p-6 backdrop-blur-2xl shadow-[0_0_50px_rgba(0,0,0,0.8)] overflow-hidden"
      >
        {/* Top Window Bar */}
        ...
        {/* Playground Grid */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 pt-6 min-h-[420px]">
          {/* Left Column: Simulated User & Claude Chat */}
          <div className="lg:col-span-6 flex flex-col justify-between rounded-2xl border border-white/5 bg-zinc-950/60 p-5 font-sans">
            <div>
              ...
              <div className="mb-6 flex gap-3">
                ...
                <div className="rounded-2xl rounded-tl-none bg-zinc-900 border border-white/10 px-4 py-3 text-sm text-zinc-200">
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  <div className="rounded-2xl rounded-tl-none bg-lime-950/30 border border-lime-500/20 px-4 py-3 text-sm text-zinc-200 leading-relaxed">
          ...
          <div className="lg:col-span-6 flex flex-col justify-between rounded-2xl border border-white/5 bg-zinc-950/90 p-5 font-mono text-xs overflow-hidden">
            <div>
              <div className="text-xs font-mono text-zinc-500 uppercase tracking-wider mb-4 flex items-center justify-between">
              ...
              {/* Tool Arguments */}
              <div className="mb-4">
                <div className="text-zinc-500 mb-1.5 flex items-center gap-1.5">
                  <Cpu className="w-3.5 h-3.5 text-lime-400" /> Action Payload (Tool Call):
                </div>
                <div className="p-3 rounded-xl bg-black border border-white/10 text-lime-300 overflow-x-auto">
              ...
              <div>
                ...
                <div className="p-3 rounded-xl bg-black border border-white/10 text-emerald-300 overflow-x-auto">
