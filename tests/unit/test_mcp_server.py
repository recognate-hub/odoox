...
def mock_repo_service():
    with patch("mcp_app.server._get_tenant_service") as mock_get_tenant:
        mock_repo = MagicMock()
        mock_service = MagicMock()
        mock_get_tenant.return_value = (mock_repo, mock_service)
...
def test_get_leads(mock_repo_service):
    ...
    from mcp_app.server import get_leads
...
def test_create_lead(mock_repo_service):
    ...
    from mcp_app.server import create_lead
...
def test_update_lead(mock_repo_service):
    ...
    from mcp_app.server import update_lead
...
def test_log_crm_note(mock_repo_service):
    ...
    from mcp_app.server import log_crm_note
...
def test_search_customer(mock_repo_service):
    ...
    from mcp_app.server import search_customer
...
def test_create_contact(mock_repo_service):
    ...
    from mcp_app.server import create_contact
...
def test_get_customer_details(mock_repo_service):
    ...
    from mcp_app.server import get_customer_details
...
def test_get_products(mock_repo_service):
    ...
    from mcp_app.server import get_products
...
def test_create_product(mock_repo_service):
    ...
    from mcp_app.server import create_product
...
def test_get_recent_quotes(mock_repo_service):
    ...
    from mcp_app.server import get_recent_quotes
...
def test_create_quote(mock_repo_service):
    ...
    from mcp_app.server import create_quote
...
def test_revenue_report(mock_repo_service):
    ...
    from mcp_app.server import revenue_report, get_sales_dashboard
...
def test_get_pipeline_forecast_data(mock_repo_service):
    ...
    from mcp_app.server import get_pipeline_forecast_data
...
def test_schedule_meeting(mock_repo_service):
    ...
    from mcp_app.server import schedule_meeting
...
def test_get_lead_context(mock_repo_service):
    ...
    from mcp_app.server import get_lead_context
...
def test_create_invoice(mock_repo_service):
    ...
    from mcp_app.server import create_invoice
...
def test_send_email(mock_repo_service):
    ...
    from mcp_app.server import send_email
...
def test_search_read_records(mock_repo_service):
    ...
    from mcp_app.server import search_read_records
...
def test_get_model_fields(mock_repo_service):
    ...
    from mcp_app.server import get_model_fields
...
def test_execute_model_method(mock_repo_service):
    ...
    from mcp_app.server import execute_model_method
    ...
    import pytest
    with pytest.raises(RuntimeError, match="Failed to execute method"):
        execute_model_method(model="sale.order", method="action_confirm")
