...
def test_get_workspace_credentials_from_redis(mock_get_cached):
    mock_ws = WorkspaceContext(
        odoo_url="url", odoo_db="db", odoo_username="user", odoo_password="pwd", user_id="u1"
    )
...
def test_get_workspace_credentials_from_supabase_success(mock_set, mock_get_supa, mock_get_cached):
    mock_get_cached.return_value = None
...
@patch("core.context.get_cached_workspace")
@patch("core.context.get_supabase")
def test_get_workspace_credentials_supabase_invalid_token(mock_get_supa, mock_get_cached):
    mock_get_cached.return_value = None
    mock_supa = MagicMock()
    mock_get_supa.return_value = mock_supa
...
@patch("core.context.get_cached_workspace")
@patch("core.context.get_supabase")
def test_get_workspace_credentials_supabase_no_workspace(mock_get_supa, mock_get_cached):
    mock_get_cached.return_value = None
    mock_supa = MagicMock()
    mock_get_supa.return_value = mock_supa
