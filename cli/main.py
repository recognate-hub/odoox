...
def seed():
    ...
    try:
        ...
        leads = [
            {
                "name": "Alpha Corp Integration",
                "email": "contact@alpha.example.com",
                "phone": "555-0101",
            },
            {
                "name": "Beta Inc Support Contract",
                "email": "info@beta.example.com",
                "phone": "555-0202",
            },
            {
                "name": "Gamma LLC Hardware Upgrade",
                "email": "sales@gamma.example.com",
                "phone": "555-0303",
            },
        ]
...
def generate_api_key(
    email: str = typer.Option(..., help="User email to generate API Key for"),
):
    ...
    try:
        ...
        if not user_id:
            console.print(
                f"[bold red]User {email} not found in Supabase Auth.[/bold red]"
            )
            sys.exit(1)
