...
def create_maintenance_request(
    name: str, equipment_id: int, description: str | None = None, priority: str = "0"
) -> dict[str, Any]:
    ...
    with _span("mcp.create_maintenance_request"):
        ...
        return service.create_maintenance_request(
            name, equipment_id, description, priority
        )
...
@mcp.tool()
@secure_tool()
def schedule_preventative_maintenance(
    equipment_id: int, next_action_date: str
) -> dict[str, Any]:
