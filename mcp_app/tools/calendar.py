...
@mcp.tool()
@secure_tool()
def get_meetings(partner_id: int | None = None, start_date: str | None = None, limit: int = 50) -> list[dict[str, Any]]:
    """
    ...
    with _span("mcp.get_meetings"):
        logger.info("MCP Tool Called: get_meetings", partner_id=partner_id, start_date=start_date)
